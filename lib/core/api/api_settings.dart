class ApiSetting{
  ...
  static const String reason = '${baseUrl}api/mobile/masjids/1/contact-us/reasons';
  static const String contactUs = '${baseUrl}api/mobile/masjids/1/contact-us';
  static const String announcements = '${baseUrl}api/mobile/masjids/1/announcements';
