                          ...
                          children: [
                            ...
                            RichText(
                                ...
                                text: TextSpan(children: [
                                  TextSpan(
                                      text:"${controller.hadith!.isnad!} ",
                                      style: TextStyle(
                                        fontFamily: "ElMessiri",
                                        fontSize: ManagerFontSize.s18,
                                        fontWeight: FontWeight.w500,
                                        color: ManagerColors.textColor.withOpacity(0.6),
                                      )),
                                  WidgetSpan(
                                      child: SizedBox(
                            ...
                            Text(controller.hadith!.muhaddith!.en!,
                                style: getRegularTextStyle(fontSize: ManagerFontSize.s16, color: ManagerColors.colorOneGradient)),
                            SizedBox(height: ManagerHeight.h10,),
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                  itemCount: controller.hadith!.references!.length,
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              controller
                                                  .hadith!.references![index].reference!,
